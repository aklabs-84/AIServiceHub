...
export default function ContentClient({ initialApps }: ContentClientProps) {
  return <ContentPage initialApps={initialApps} />;
}

function ContentPageInner({ initialApps }: ContentClientProps) {
  const { user } = useAuth();
