...
const faqs = [
  ...
  {
    q: '로그인이 안 되거나 무한 로딩이 발생해요.',
    a: '브라우저 로컬 스토리지에 이전 인증 정보가 남아있을 수 있습니다. 개발자 도구(F12) → Application → Local Storage에서 해당 사이트의 데이터를 삭제한 후 새로고침 해보세요.',
  },
  {
    q: '크롬 브라우저에서 페이지가 제대로 동작하지 않아요.',
    a: '설정 → 개인정보 및 보안 → 인터넷 사용 기록 삭제에서 캐시/쿠키를 삭제한 뒤 다시 접속해 보세요.',
  },
];
