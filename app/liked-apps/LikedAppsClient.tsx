...
export default function LikedAppsClient({ initialUserId, initialApps }: LikedAppsClientProps) {
        ...
        <div className="animate-fadeIn">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
            {apps.map((app, index) => (
              ...
              >
                <AppCard app={app} onLikeChange={handleReload} categoryInfo={getCategoryInfo(app.category, appCategories)} />
              </div>
            ))}
          </div>
        </div>
