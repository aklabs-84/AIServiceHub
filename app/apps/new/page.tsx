...
import { FaPaperclip, FaSave, FaPlus, FaTrash, FaGlobe, FaLock, FaLink, FaGripVertical } from 'react-icons/fa';
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-200">
                웹 URL{!formData.htmlCode.trim() && <span className="text-red-500"> *</span>}
                {formData.htmlCode.trim() && <span className="ml-1 text-xs text-violet-500 font-normal">(HTML 업로드 시 선택)</span>}
              </label>
              <button
                type="button"
                onClick={addUrlField}
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex-1 relative">
                        ...
                        <input
                          type="url"
                          required={index === 0 && !formData.htmlCode.trim()}
                          value={urlItem.url}
