...
export const appCategoryDefaults = [
  ...
  { value: 'data-analysis', label: '데이터 분석', icon: 'chart', color: 'bg-green-500' },
  { value: 'image-generation', label: '이미지 생성', icon: 'image', color: 'bg-pink-500' },
  { value: 'code-assistant', label: '코드 어시스턴트', icon: 'code', color: 'bg-yellow-500' },
  { value: 'translation', label: '번역', icon: 'language', color: 'bg-indigo-500' },
  ...
  { value: 'other', label: '기타', icon: 'puzzle', color: 'bg-gray-500' },
];
...
export const promptCategoryDefaults = [
  ...
  { value: 'image', label: '이미지', icon: 'image', color: 'bg-cyan-500' },
  { value: 'relationship', label: '관계', icon: 'heart', color: 'bg-pink-500' },
